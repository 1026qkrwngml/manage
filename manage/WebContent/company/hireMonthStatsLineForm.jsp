...
new Morris.Line({
	...
	data:	[
		{ month: m01,	value: <%=rs.getString("m1") %> },
		{ month: m02,	value: <%=rs.getString("m2") %> },
		{ month: m03,	value: <%=rs.getString("m3") %> },
		{ month: m04,	value: <%=rs.getString("m4") %> },
		{ month: m05,	value: <%=rs.getString("m5") %> },
		{ month: m06,	value: <%=rs.getString("m6") %> },
		{ month: m07,	value: <%=rs.getString("m7") %> },
		{ month: m08,	value: <%=rs.getString("m8") %> },
		{ month: m09,	value: <%=rs.getString("m9") %> },
		{ month: m10,	value: <%=rs.getString("m10") %> },
		{ month: m11,	value: <%=rs.getString("m11") %> },
		{ month: m12,	value: <%=rs.getString("m12") %> },
	],
